...
export function LocaleSwitcher({ ariaLabel }: { ariaLabel: string }) {
  ...
  return (
    <nav
      className="relative z-[1] flex shrink-0 items-center gap-0.5 rounded-md border border-opus-gold/35 bg-opus-slate/60 px-0.5 py-0.5 shadow-[0_0_0_1px_rgba(0,0,0,0.35)]"
      ...
      {locales.map((loc) => {
        ...
        return (
          <Link
            ...
            className={`rounded px-2 py-1 font-sans text-[0.65rem] font-semibold uppercase tracking-[0.12em] transition md:px-2.5 md:text-[0.7rem] ${
              active
