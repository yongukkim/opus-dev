...
export const ja: Messages = {
  meta: {
    ...
    aboutTitle: "OPUSについて",
    aboutDescription:
      "OPUSとは何か：認証された複製不可デジタルアートのエディション、The Chronicle、コレクター体験中心の鑑賞 — ストック画像ショップや汎用ECのカートではありません。",
  ...
  aboutPage: {
    ...
    title: "OPUSについて",
    lead:
      "OPUSは、複製不可のデジタルアートの認証エディションと、アーカイブに入った経路・その後の所蔵の移り変わりをあわせて示すために設計されています。ストックライブラリや汎用ECに慣れていると最初は違和感があるかもしれません。このページは短いオリエンテーションの草案です。",
    sWhyTitle: "企画意図",
    sWhyP1:
      "生成技術による画像も、技術の進歩のなかで人が享受してよい便益の一面があります。一方で、そこに紛れやすい喪失もあります。線を選び直し、色に迷い、作品として差し出すまでの**人間の作家の体温と息づかい**です。OPUSの企画は道具を断罪することではなく、その体温が画素の流れだけに薄まらないよう、人が主導する一次エディションを認証・記録・鑑賞の体験として高めることにあります。",
    sWhyP2:
      "出所と工程が読みにくいとき、最初に失われやすいのがその存在感です。日本のイラストレーション界隈や隣接するファン文化の議論でも、同意・権利・表示が繰り返し論点になります。技術そのものを一律に拒否する単一の世論ではありませんが、「誰の手で作られたか」が読めないときに不信が強まるのは、同じ構造の問題です。",
    sWhyP3:
      "OPUSはプロダクトで応えます。運営文脈のある発行情報、識別子をマスクしつつ公開するThe Chronicle、差し替え可能なファイルではなく認証エディションへつながるコレクター導線です。著作者人格権・著作権は作家に残り、OPUSは新作公開と所蔵の物語を通じて、作家の決断が記録と鑑賞のなかで途切れないようにするサービス層です。",
    s1Title: "ストック画像マーケットではありません",
    s1p1:
      "ストックサイトはキャンペーンやレイアウト向けに差し替え可能なファイルを扱います。OPUSの新作公開は、作家がOPUSで初めて公開する一次エディションを扱い、各詳細は特定の作品とエディション境界、運営文脈の発行情報を前提とします。",
    s1p2:
      "汎用ダウンロードのトークンを買う構造ではなく、OPUSのルールのもとで認証エディションとして扱われるカタログに参加する体験です。",
    s2Title: "新作公開 · The Chronicle · 来歴",
    s2p1:
      "新作公開は、OPUS上でエディションが初めて現れる場所です。The Chronicleは運営が維持する公開発行記録（識別子マスク、公開チェーンエクスプローラではありません）です。来歴は次の所蔵者を探す導線で、custody transfer（所蔵の移転）として案内します。",
    s2p2:
      "これらがあわさり、エディションに何が起きたか、誰が次に預かれるかを説明しますが、実名や非公開の連絡先を掲載するものではありません。",
    s3Title: "お支払いが意味すること",
    s3p1:
      "お支払いは、このアーカイブへの参加を確定します。認証エディション枠、OPUSが定義するコレクター体験（鑑賞パスを含む）、由来と説明責任を支える記録の連続性です。",
    s3p2:
      "OPUSはエディションを金融商品として位置づけません。価値の語りは真正性・所蔵の明確さ・サービス内での鑑賞です。",
    s4Title: "Webとモバイルアプリ",
    s4p1:
      "Webは発見、信頼面、解像度を抑えたプレビュー向けに調整されています。検証済み所蔵者向けの高精細鑑賞は、製品方針に沿った認証モバイル経路を前提とします。",
    draftNote: "草案の案内文 — 法務・ブランド確認のうえ、大規模流入前に整えてください。",
  },
  vaultNav: {
    collection: "コレクション",
    activity: "アクティビティ",
