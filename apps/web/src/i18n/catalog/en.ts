...
export const en: Messages = {
  ...
  artistOnboarding: {
    ...
    body: "Your pen name is used as your public artist identity and is locked after initial setup. Payout account details are used for settlement after sales.",
    displayNameLabel: "Pen name",
  ...
  artistProfile: {
    ...
    body:
      "Manage your display name and bio. SSO profile photos are private by default and only shown when you opt in.",
    displayNameLabel: "Pen name",
    displayNamePlaceholder: "e.g., HARU",
    displayNameLockedHint: "Pen name cannot be changed after initial setup.",
    displayNameSetupHint: "Set your pen name once during artist onboarding.",
    penNameLockedBanner: "Your pen name is already locked and cannot be changed.",
    bioLabel: "Bio",
  ...
  submitArtwork: {
    ...
    nicknameAutoHint: "Your locked pen name is automatically applied to every submission.",
    penNameRequiredTitle: "Pen name setup required",
    penNameRequiredBody:
      "Before submitting artwork, set your pen name in Artist Profile first. Pen name is locked after the first save.",
