...
export const en: Messages = {
  ...
  auth: {
    signIn: "Sign in",
    title: "Sign in",
    subtitle: "Sign in with Google, Apple, LINE, or email.",
    ...
    providerNotConfigured: "{name} sign-in is not configured on this server.",
    signOut: "Sign out",
    ...
    loginInvalidCredentialsAlert:
      "Check your email and password. If you just registered, confirm you completed the verification link from your inbox.",
    verifyEmailOkBanner: "Your email is verified. You can sign in now.",
    verifyEmailInvalidBanner: "This verification link is not valid. Try signing up again or resend the verification email.",
    verifyEmailExpiredBanner: "This verification link has expired. You can resend the verification email below.",
    resendVerificationSummary: "Didn’t get the email?",
    resendVerificationSubmit: "Resend verification email",
    resendVerificationSending: "Sending…",
    resendVerificationDone: "Request received. Check your inbox and spam folder.",
  ...
  signup: {
    ...
    registerFailedAlert: "Registration failed. Please try again.",
    registerEmailTaken: "This email is already registered. Please sign in.",
    registerOAuthEmailExists: "This email is already linked to a social account. Please sign in with that provider.",
    registerPasswordWeak:
      "Use at least 10 characters including an uppercase letter, a lowercase letter, a number, and a symbol.",
    registerEmailInvalid: "Enter a valid email address.",
    registerConsentRequired: "Required consent is missing. Refresh the page and try again.",
    registering: "Creating account…",
    registerVerificationSent: "You’re registered. We sent a verification email to the address you entered.",
    registerVerificationCheckSpam: "If you don’t see it, check spam or promotions.",
  ...
  artistSignup: {
    ...
    registerFailedAlert: "Artist registration failed. Please try again.",
    registerEmailTaken: "This email is already registered. Please sign in.",
    registerOAuthEmailExists: "This email is already linked to a social account. Please sign in with that provider.",
    registerPasswordWeak:
      "Use at least 10 characters including an uppercase letter, a lowercase letter, a number, and a symbol.",
  ...
  submitArtwork: {
    ...
    genreKeywordsLabel: "Tag keywords",
    genreKeywordsHint: "Tap to add or remove the keyword in the tags field below.",
  ...
  collectorTransfer: {
    ...
    genreOptPixelArt: "Pixel art",
    genreOptSf: "Science fiction",
    genreOptAnimeStyle: "Anime style",
