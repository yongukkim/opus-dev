...
export const ko: Messages = {
  meta: {
    ...
    aboutTitle: "OPUS 소개",
    aboutDescription:
      "OPUS가 무엇인지: 인증된 복제 불가능한 디지털 아트 에디션, The Chronicle, 소장자 중심 감상 경로 — 스톡 이미지 쇼핑몰이나 일반 결제 카트가 아닙니다.",
  ...
  aboutPage: {
    ...
    title: "OPUS 소개",
    lead:
      "OPUS는 복제 불가능한 디지털 아트의 인증된 에디션을, 아카이브에 들어온 경로와 이후 수탁이 어떻게 이어지는지를 함께 보여 주기 위해 설계되었습니다. 스톡 라이브러리나 일반 이커머스에 익숙하다면 처음엔 낯설 수 있어, 이 페이지는 짧은 안내용 초안입니다.",
    sWhyTitle: "기획 취지",
    sWhyP1:
      "AI가 만든 이미지도 기술이 가져온 편의이며, 사람이 누려도 되는 영역이라고 봅니다. 다만 그렇게 쌓이는 픽셀 사이에서 잊히기 쉬운 것이 있습니다. 붓을 잡은 이의 결, 시간을 들인 선택, 작품으로 내놓기까지의 **진짜 창작자의 온기와 숨결**입니다. OPUS의 취지는 도구를 부정하는 데 있지 않고, 그 온기와 숨결이 서비스 안에서 흐려지지 않도록 인간이 주도한 1차 에디션을 인증·기록·감상 경험으로 높이는 데 있습니다.",
    sWhyP2:
      "출처와 과정이 흐려지면, 소장자에게 가장 먼저 사라지기 쉬운 것이 바로 그 존재감입니다. 일본의 일러스트레이션·팬 문화 인접 담론에서도 동의·권리·표시가 쟁점으로 자주 돌아옵니다. 기술 전체를 한꺼번에 거부하는 단일 여론은 아니지만, ‘누가 어떤 손으로 만들었는지’가 읽히지 않을 때 불신이 커지는 패턴은 분명합니다.",
    sWhyP3:
      "그래서 OPUS는 제품으로 답합니다: 운영 맥락이 붙은 발행 정보, 식별자는 마스킹한 채 공개되는 The Chronicle, ‘바꿔 쓰는 파일’이 아니라 **작가의 결**이 이어지는 인증 에디션과 수탁 서사입니다. 저작 인격권·저작권은 작가에게 남고, OPUS는 그 온기가 기록과 감상 속에서 끊기지 않도록 하는 서비스 층입니다.",
    s1Title: "스톡 이미지 마켓이 아닙니다",
    s1p1:
      "스톡 사이트는 캠페인·레이아웃용으로 바꿔 쓸 수 있는 파일을 팝니다. OPUS의 신작 공개는 작가가 OPUS에서 최초로 공개하는 1차 에디션을 다루며, 각 상세는 특정 작품과 에디션 경계, 운영 맥락의 발행 정보를 전제로 합니다.",
    s1p2:
      "범용 다운로드 토큰을 사는 구조가 아니라, OPUS 규칙 안에서 인증된 에디션으로 취급되는 카탈로그에 들어가는 경험입니다.",
    s2Title: "신작 공개 · The Chronicle · 소장품",
    s2p1:
      "신작 공개는 OPUS에서 에디션이 처음 나타나는 곳입니다. The Chronicle은 운영이 유지하는 공개 발행 기록(식별자 마스킹, 공개 체인 익스플로러 아님)입니다. 소장품은 다음 수탁자를 찾는 경로로, 수탁 이전(custody transfer)의 관점에서 안내합니다.",
    s2p2:
      "이 세 표면이 함께 에디션에 무슨 일이 있었는지, 누가 다음에 맡을 수 있는지 설명하되, 상세에 실명이나 비공개 연락처를 싣지는 않습니다.",
    s3Title: "결제가 의미하는 것",
    s3p1:
      "결제는 이 아카이브에 참여하는 것을 확정합니다: 인증된 에디션 슬롯, OPUS가 정의하는 소장자 경험(감상 경로 포함), 출처와 책임을 뒷받침하는 기록의 연속성입니다.",
    s3p2:
      "OPUS는 에디션을 금융 상품으로 포지셔닝하지 않습니다. 가치 서사는 진본성·수탁의 명확성·서비스 안에서의 감상입니다.",
    s4Title: "웹과 모바일 앱",
    s4p1:
      "웹은 발견, 신뢰 표면, 제한된 해상도 프리뷰에 맞춰 있습니다. 검증된 소장자를 위한 고해상 감상은 제품 정책에 따른 인증 모바일 경로를 전제로 합니다.",
    draftNote: "초안 안내 문구 — 법무·브랜드 검토 후 대규모 유입 전에 다듬을 것.",
  },
  vaultNav: {
    collection: "컬렉션",
    activity: "활동",
