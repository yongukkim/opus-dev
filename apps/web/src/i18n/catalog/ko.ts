...
export const ko: Messages = {
  ...
  artistOnboarding: {
    ...
    heading: "필명 및 정산 정보",
    body: "필명은 공개 작가명으로 사용되며 최초 1회 설정 후 변경할 수 없습니다. 계좌 정보는 판매 정산에 사용됩니다.",
    displayNameLabel: "필명",
  ...
  artistProfile: {
    ...
    heading: "프로필 설정",
    body:
      "표시 이름과 소개 문구를 관리합니다. 프로필 이미지는 SSO 계정 사진을 사용 여부를 직접 선택해야 공개됩니다.",
    displayNameLabel: "필명",
    displayNamePlaceholder: "예: HARU",
    displayNameLockedHint: "필명은 최초 설정 후 변경할 수 없습니다.",
    displayNameSetupHint: "필명은 작가 등록 시 1회만 설정할 수 있습니다.",
    penNameLockedBanner: "필명은 이미 확정되어 변경할 수 없습니다.",
    bioLabel: "소개",
  ...
  submitArtwork: {
    ...
    nicknameLabel: "필명",
    nicknameAutoHint: "작가 등록 시 확정한 필명이 자동으로 적용되며, 작품별 변경은 불가합니다.",
    penNameRequiredTitle: "필명 설정이 필요합니다",
    penNameRequiredBody:
      "작품 등록 전에 작가 프로필에서 필명을 먼저 등록해 주세요. 필명은 최초 1회 설정 후 변경할 수 없습니다.",
