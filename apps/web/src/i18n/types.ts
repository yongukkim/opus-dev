...
export type Messages = {
  ...
  accountSettings: {
    ...
    savedBanner: string;
    payoutBankHeading: string;
    payoutBankBody: string;
    bankNameLabel: string;
    bankNamePlaceholder: string;
    accountHolderLabel: string;
    accountHolderPlaceholder: string;
    accountNumberLabel: string;
    accountNumberPlaceholder: string;
    payoutBankSaveCta: string;
    payoutBankSavingCta: string;
    payoutBankSaved: string;
    payoutBankError: string;
    payoutBankLoadError: string;
    paymentMethodHeading: string;
    paymentMethodBody: string;
    ...
    brandJcb: string;
    brandDiners: string;
    brandUnionpay: string;
    brandOther: string;
    last4Label: string;
    last4Placeholder: string;
    expMonthLabel: string;
    expYearLabel: string;
    paymentMethodSaveCta: string;
    paymentMethodSavingCta: string;
    ...
    withdrawConfirmPlaceholder: string;
    withdrawConfirmMismatch: string;
    withdrawFailed: string;
    withdrawCta: string;
    withdrawingCta: string;
  };
